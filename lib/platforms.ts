...
export const platforms = [
  ...
  },
  {
    ...
    placements: [
      ...
      { id: "dribbble-post", category: "post", label: "Shot image", width: 1600, height: 1200 },
    ],
  },
  {
    id: "behance", name: "Behance", mark: "Be", color: "#1769ff",
    placements: [
      { id: "behance-profile", category: "profile", label: "Profile picture", width: 320, height: 320 },
      { id: "behance-cover", category: "cover", label: "Profile banner", width: 3200, height: 410 },
      { id: "behance-post", category: "post", label: "Project cover", width: 808, height: 632 },
    ],
  },
  {
